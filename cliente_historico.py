...
class ClienteHistorico(Toplevel):
    ...
    def mostrar_reserva(self):
        ...
        for reserva in reservas:
            usuario = select_usuario_by_id(conn, self.id_cliente)[0][1] + " " + select_usuario_by_id(conn, self.id_cliente)[0][2]
